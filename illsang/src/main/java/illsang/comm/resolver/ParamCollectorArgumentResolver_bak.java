...
public class ParamCollectorArgumentResolver_bak implements HandlerMethodArgumentResolver {

	private static final Logger log = LoggerFactory.getLogger(ParamCollectorArgumentResolver_bak.class);
	...
	public Object resolveArgument(MethodParameter prameter, ModelAndViewContainer mavContainer,
		...
		if (log.isDebugEnabled()) {
			...
			log.debug(" Request Session \t:  " + session.getAttribute("gv_userId"));
		}
