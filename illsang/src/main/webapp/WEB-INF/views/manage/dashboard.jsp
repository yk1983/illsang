...
<c:import url="/WEB-INF/views/manage/include/header.jsp">
	<c:param name="gv_viewType" value="dashboard" />
</c:import>
				...
				<div class="kt-portlet__body kt-portlet__body--fluid">
					<div class="kt-widget-19">
						<div class="kt-widget-19__title">
							...
							<img class="kt-widget-19__bg" src="/media/misc/iconbox_bg.png" alt="bg" />
						</div>
				...
				<div class="kt-portlet__body kt-portlet__body--fluid">
					<div class="kt-widget-21">
						<div class="kt-widget-21__title">
							...
							<img src="/media/misc/iconbox_bg.png" class="kt-widget-21__bg" alt="bg" />
						</div>
				...
				<div class="kt-portlet__body kt-portlet__body--fluid">
					<div class="kt-widget-20">
						<div class="kt-widget-20__title">
							...
							<img class="kt-widget-20__bg" src="/media/misc/iconbox_bg.png" alt="bg" />
						</div>
				...
				<div class="kt-portlet__body">
					<div class="kt-widget-1">
						<ul class="nav nav-pills nav-tabs-btn nav-pills-btn-brand" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#kt_tabs_19_15e0398aa838ce" role="tab">
									<span class="nav-link-icon"><i class="flaticon2-graphic"></i></span>
									<span class="nav-link-title">Settings</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_25e0398aa838ce" role="tab">
									<span class="nav-link-icon"><i class="flaticon2-position"></i></span>
									<span class="nav-link-title">Code</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_35e0398aa838ce" role="tab">
						...
						<div class="tab-content">
							<div class="tab-pane fade active show" id="kt_tabs_19_15e0398aa838ce" role="tabpanel">
							...
							<div class="tab-pane fade" id="kt_tabs_19_25e0398aa838ce" role="tabpanel">
								<div class="kt-widget-1__item">
									<div class="kt-widget-1__item-info">
										<a href="#" class="kt-widget-1__item-title">UI/UX Design</a>
										<div class="kt-widget-1__item-desc">Evrything you ever imagine</div>
							...
							<div class="tab-pane fade" id="kt_tabs_19_35e0398aa838ce" role="tabpanel">
								<div class="kt-widget-1__item">
									<div class="kt-widget-1__item-info">
										<a href="#" class="kt-widget-1__item-title">eCommerce Websites</a>
										<div class="kt-widget-1__item-desc">Shops, Fasion wep sites & atc</div>
				...
				<div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--fluid">
					<div class="kt-widget-7">
						<div class="kt-widget-7__items">
							...
							<div class="kt-widget-7__item">
								<div class="kt-widget-7__item-pic">
									<img src="/media/files/zip.svg" alt="" />
								</div>
								<div class="kt-widget-7__item-info">
									<a href="#" class="kt-widget-7__item-title">
										ST.11 Dacuments
							...
							<div class="kt-widget-7__item">
								<div class="kt-widget-7__item-pic">
									<img src="/media/files/xml.svg" alt="" />
								</div>
								<div class="kt-widget-7__item-info">
									<a href="#" class="kt-widget-7__item-title">
						...
						<div class="kt-widget-7__foot">
							<img src="/media/misc/clouds.png" alt="" />
...
<c:import url="/WEB-INF/views/manage/include/footer.jsp">
	<c:param name="gv_actionJs" value="dashboard.js" />
	<c:param name="gdsNavigation" value="${gdsNavigation }" />
</c:import>