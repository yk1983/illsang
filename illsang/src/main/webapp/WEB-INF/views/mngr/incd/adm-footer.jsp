...
<footer class="footer">
	<div
		class="container<c:if test="${param.tpl_type eq 'fluid' }">-fluid</c:if>">
		...
		<div class="copyright float-right">
			Copyright&copy; 2020. <a href="/" target="_blank">Cafe iLLSang</a>.
			All right reserved.
		</div>
	</div>
</footer>
	...
	<div class="dropdown show-dropdown">
		...
		<ul class="dropdown-menu">
			...
			<li class="active"><a class="img-holder switch-trigger"
				href="javascript:void(0)"> <img src="/img/mngr/sidebar-1.jpg"
					alt="">
			</a></li>
			<li><a class="img-holder switch-trigger"
				href="javascript:void(0)"> <img src="/img/mngr/sidebar-2.jpg"
					alt="">
			</a></li>
			<li><a class="img-holder switch-trigger"
				href="javascript:void(0)"> <img src="/img/mngr/sidebar-3.jpg"
					alt="">
			</a></li>
			<li><a class="img-holder switch-trigger"
				href="javascript:void(0)"> <img src="/img/mngr/sidebar-4.jpg"
					alt="">
			</a></li>
			<li class="button-container"><a
				...
				target="_blank" class="btn btn-default btn-block"> Documentation
			</a> <a href="https://www.creative-tim.com/product/material-dashboard"
				target="_blank" class="btn btn-info btn-block"> Get Free Demo! </a></li>
...
<c:if test="${param.tpl_type eq 'fluid' }">
...
<script src="/js/dashboard.js?v=2.1.0" type="text/javascript"></script>
