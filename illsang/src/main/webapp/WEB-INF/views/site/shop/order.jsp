...
<c:import url="/WEB-INF/views/site/incd/header.jsp">
	<c:param name="shop" value="active" />
</c:import>
				...
				<div class="checkout_details_area mt-50 clearfix">
					...
					<form action="#" method="post">
						<div class="row">
							...
							<div class="col-12 mb-3">
								<textarea name="comment" class="form-control w-100" id="comment"
									cols="30" rows="10"
							...
							<div class="col-12">
								<div class="custom-control custom-checkbox d-block mb-2">
									<input type="checkbox" class="custom-control-input"
										...
										for="customCheck2">Create an accout</label>
								</div>
								<div class="custom-control custom-checkbox d-block">
									<input type="checkbox" class="custom-control-input"
										id="customCheck3"> <label class="custom-control-label"
										for="customCheck3">Ship to a different address</label>
								</div>
							</div>
						</div>
					</form>
			...
			<div class="col-12 col-lg-4">
				<div class="cart-summary">
					...
					<div class="cart-btn mt-100">
						<a href="#" class="btn amado-btn w-100">결재하기</a>
					</div>
				</div>
			</div>
		</div>
