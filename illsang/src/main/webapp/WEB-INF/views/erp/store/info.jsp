...
<c:import url="/WEB-INF/views/erp/include/header.jsp"></c:import>
									...
									<div class="col-xl-8">
										<div class="kt-section kt-section--first">
											<div class="kt-section__body">
												<h3 class="kt-section__title kt-section__title-lg">카페 정보:</h3>
												<div class="form-group row">
													<label class="col-3 col-form-label">커페명(한글)</label>
													<div class="col-9">
														<input class="form-control" type="text" value="Nick">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-3 col-form-label">카페명(영문)</label>
													<div class="col-9">
														<input class="form-control" type="text" value="Watson">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-3 col-form-label">대표명</label>
													<div class="col-9">
												...
												<div class="form-group row">
													<label class="col-3 col-form-label">매장 전화번호</label>
													<div class="col-9">
												...
												<div class="form-group row">
													<label class="col-3 col-form-label">휴대 전화번호</label>
													<div class="col-9">
														<div class="input-group">
															<div class="input-group-prepend"><span class="input-group-text"><i class="la la-phone"></i></span></div>
															<input type="text" class="form-control" value="+45678967456" placeholder="Phone" aria-describedby="basic-addon1">
												...
												<div class="form-group row">
													<label class="col-3 col-form-label">홈페이지</label>
													<div class="col-9">
														<div class="input-group">
												...
												<div class="form-group row">
													<label class="col-3 col-form-label">페이스북</label>
													<div class="col-9">
														<div class="input-group">
															<input type="text" class="form-control" placeholder="Username" value="loop">
															<div class="input-group-append"><span class="input-group-text">.com</span></div>
												...
												<div class="form-group row">
													<label class="col-3 col-form-label">인스타그램</label>
													<div class="col-9">
														<div class="input-group">
															<input type="text" class="form-control" placeholder="Username" value="loop">
															<div class="input-group-append"><span class="input-group-text">.com</span></div>
												...
												<div class="form-group form-group-last row">
													<label class="col-3 col-form-label">트위터</label>
													<div class="col-9">
														<div class="input-group">
															<input type="text" class="form-control" placeholder="Username" value="loop">
															<div class="input-group-append"><span class="input-group-text">.com</span></div>
										...
										<div class="kt-section">
											<div class="kt-section__body">
												<h3 class="kt-section__title kt-section__title-lg">주소:</h3>
												<div class="form-group row">
...
<c:import url="/WEB-INF/views/erp/include/footer.jsp">
	<c:param name="action_js" value="menu" />
</c:import>